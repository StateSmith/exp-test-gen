...
static void OFF_resume(LightSm* sm);
...
static void OFF_enter(LightSm* sm)
{
    ...
    sm->current_event_handlers[LightSm_EventId_RESUME] = OFF_resume;
...
static void OFF_exit(LightSm* sm)
{
    ...
    sm->current_event_handlers[LightSm_EventId_RESUME] = NULL;  // no ancestor listens to this event
}
...
static void OFF_resume(LightSm* sm)
{
    ...
    // uml: RESUME TransitionTo(ON_GROUP.<History>)
    {
        ...
        if (sm->vars.ON_GROUP_history == LightSm_ON_GROUP_HistoryId_ON_HOT)
        {
...
static void ON_HOT_enter(LightSm* sm)
{
    ...
    // uml: enter / { $gil(this.vars.ON_GROUP_history = ON_GROUP_HistoryId.ON_HOT;) }
    {
        ...
        sm->vars.ON_GROUP_history = LightSm_ON_GROUP_HistoryId_ON_HOT;
    } // end of behavior for ON_HOT
}
...
char const * LightSm_event_id_to_string(LightSm_EventId id)
{
    switch (id)
    {
        ...
        case LightSm_EventId_RESUME: return "RESUME";
        default: return "?";
    }
}
