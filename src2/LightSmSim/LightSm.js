...
class LightSm
{
    ...
    #ROOT_enter()
    {
        ...
        // ROOT behavior
        // uml: enter / { console.log("Entered LightSm."); }
        {
            // Step 1: execute action `console.log("Entered LightSm.");`
            console.log("Entered LightSm.");
        } // end of behavior for ROOT
    }
    ...
    {
        // ROOT behavior
        // uml: exit / { console.log("Exited LightSm."); }
        {
            // Step 1: execute action `console.log("Exited LightSm.");`
            console.log("Exited LightSm.");
        } // end of behavior for ROOT
    }
    ...
    #OFF_enter()
    {
        ...
        this.#currentEventHandlers[LightSm.EventId.RESUME] = this.#OFF_resume;
    ...
    #OFF_exit()
    {
        ...
        this.#currentEventHandlers[LightSm.EventId.RESUME] = null;  // no ancestor listens to this event
    }
    ...
    #OFF_resume()
    {
        ...
        // uml: RESUME TransitionTo(ON_GROUP.<History>)
        {
            ...
            if (console.log("History state evaluating guard: " + "$gil(this.vars.ON_GROUP_history == ON_GROUP_HistoryId.ON_HOT)") || this.vars.ON_GROUP_history == LightSm.ON_GROUP_HistoryId.ON_HOT)
            {
            ...
            if (console.log("History state evaluating guard: " + "$gil(this.vars.ON_GROUP_history == ON_GROUP_HistoryId.ON2)") || this.vars.ON_GROUP_history == LightSm.ON_GROUP_HistoryId.ON2)
            {
                // Step 1: Exit states until we reach `ON_GROUP` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
    ...
    #ON_HOT_enter()
    {
        ...
        // uml: enter / { $gil(this.vars.ON_GROUP_history = ON_GROUP_HistoryId.ON_HOT;)console.log("Executed action: " + "$gil(this.vars.ON_GROUP_history = ON_GROUP_HistoryId.ON_HOT;)"); }
        {
            ...
            this.vars.ON_GROUP_history = LightSm.ON_GROUP_HistoryId.ON_HOT;console.log("Executed action: " + "$gil(this.vars.ON_GROUP_history = ON_GROUP_HistoryId.ON_HOT;)");
        } // end of behavior for ON_HOT
    }
    ...
    #ON1_enter()
    {
        ...
        // uml: enter / { $gil(this.vars.ON_GROUP_history = ON_GROUP_HistoryId.ON1;)console.log("Executed action: " + "$gil(this.vars.ON_GROUP_history = ON_GROUP_HistoryId.ON1;)"); }
        {
            ...
            this.vars.ON_GROUP_history = LightSm.ON_GROUP_HistoryId.ON1;console.log("Executed action: " + "$gil(this.vars.ON_GROUP_history = ON_GROUP_HistoryId.ON1;)");
        } // end of behavior for ON1
    }
    ...
    #ON2_enter()
    {
        ...
        // uml: enter / { $gil(this.vars.ON_GROUP_history = ON_GROUP_HistoryId.ON2;)console.log("Executed action: " + "$gil(this.vars.ON_GROUP_history = ON_GROUP_HistoryId.ON2;)"); }
        {
            ...
            this.vars.ON_GROUP_history = LightSm.ON_GROUP_HistoryId.ON2;console.log("Executed action: " + "$gil(this.vars.ON_GROUP_history = ON_GROUP_HistoryId.ON2;)");
        } // end of behavior for ON2
    }
    ...
    static eventIdToString(id)
    {
        switch (id)
        {
            ...
            case LightSm.EventId.RESUME: return "RESUME";
            default: return "?";
        }
    }
}
